...
// Kind values.
const (
	KindFAILCREDENTIAL         Kind = "FAIL_CREDENTIAL"
...
func KindValidator(k Kind) error {
	switch k {
	case KindFAILCREDENTIAL, KindCREATEJOB, KindCREATETAG, KindAPPLYTAGTOTASK, KindAPPLYTAGTOTARGET, KindAPPLYTAGTOJOB, KindREMOVETAGFROMTASK, KindREMOVETAGFROMTARGET, KindREMOVETAGFROMJOB, KindCREATETARGET, KindSETTARGETFIELDS, KindDELETETARGET, KindADDCREDENTIALFORTARGET, KindCREATELINK, KindSETLINKFIELDS, KindACTIVATEUSER, KindMAKEADMIN, KindREMOVEADMIN, KindCHANGENAME, KindLIKEEVENT, KindOTHER:
		return nil
	default:
