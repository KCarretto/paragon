...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "dd66deabbf767619cd56";
...
class ParagonAPI extends apollo_datasource_rest_1.RESTDataSource {
    ...
    getAllTargets(filter, offset, limit) {
...
exports.default = {
    Query: {
        ...
        targets: (root, { filter, offset, limit }, { dataSources }) => dataSources.paragonAPI.getAllTargets(filter, offset, limit),
