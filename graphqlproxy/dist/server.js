...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "e921d3ef7f4bf10be7f4";
...
class ParagonAPI extends apollo_datasource_rest_1.RESTDataSource {
    constructor() {
        super();
    ...
    getAllTargets(args) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("WAT");
            const result = yield this.get("/api/v1/targets", args);
            console.log(result);
            return [];
        });
    }
    getATarget(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.get("/api/v1/targets", {
                id
            });
            return result;
        });
    }
    createTarget(name, primaryIP, tags) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post("/api/v1/targets/create", { name, primaryIP, tags });
            return result;
        });
    }
    setTargetFields(args) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.post("/api/v1/targets/setTargetFields", args);
            return result;
        });
    }
}
exports.ParagonAPI = ParagonAPI;
...
const datasource_1 = __webpack_require__(/*! ./datasource */ "./src/datasource.ts");
...
const server = new apollo_server_1.ApolloServer({
    ...
    dataSources: () => ({
        paragonAPI: new datasource_1.ParagonAPI()
    })
});
server.listen(environment_1.environment.port).then(({ url }) => console.log(`Server ready at ${url}. `));
if (true) {
    module.hot.accept();
...
exports.default = {
    Query: {
        ...
        targets: (root, args, { dataSources }) => dataSources.paragonAPI.getAllTargets(args),
        target: (root, { id }, { dataSources }) => dataSources.paragonAPI.getTarget(id)
    },
    Mutation: {
        createTarget: (root, { name, primaryIP, tags }, { dataSources }) => dataSources.paragonAPI.createTarget(name, primaryIP, tags),
        setTargetFields: (root, args, { dataSources }) => dataSources.paragonAPI.setTargetFields(args)
    }
};
