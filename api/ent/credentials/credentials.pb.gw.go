...
func request_Credentials_Fail_0(ctx context.Context, marshaler runtime.Marshaler, client CredentialsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FailRequest
	var metadata runtime.ServerMetadata
...
func local_request_Credentials_Fail_0(ctx context.Context, marshaler runtime.Marshaler, server CredentialsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq FailRequest
	var metadata runtime.ServerMetadata
...
func RegisterCredentialsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CredentialsServer) error {
	...
	mux.Handle("POST", pattern_Credentials_Fail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Credentials_Fail_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Credentials_Fail_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCredentialsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CredentialsClient) error {
	...
	mux.Handle("POST", pattern_Credentials_Fail_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Credentials_Fail_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Credentials_Fail_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "credentials", "fail"}, "", runtime.AssumeColonVerbOpt(true)))
)
...
var (
	...
	forward_Credentials_Fail_0 = runtime.ForwardResponseMessage
)
