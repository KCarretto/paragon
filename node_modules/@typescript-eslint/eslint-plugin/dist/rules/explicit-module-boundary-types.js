...
exports.default = util.createRule({
    ...
    create(context, [options]) {
        ...
        function checkFunctionReturnType(node) {
            const paramIdentifiers = node.params.filter(param => param.type === experimental_utils_1.AST_NODE_TYPES.Identifier);
        ...
        function checkFunctionExpressionReturnType(node) {
            ...
            /* istanbul ignore else */ if (node.parent) {
                if (node.parent.type === experimental_utils_1.AST_NODE_TYPES.MethodDefinition &&
